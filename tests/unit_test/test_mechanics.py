import pytest
from app.mechanics import day_of_year, create_date_obj, display_date, get_rak_of
...
@pytest.mark.parametrize(
    "test_date, expected",
    [("2018-12-18", "352"), ("2018-7-2", "183"), ("2018-4-1", "91")],
)
...
def test_get_rak_of(test_date, expected_rak):
    ...
    assert get_rak_of(_day_of_year) == expected_rak
